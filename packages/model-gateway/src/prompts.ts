...
First, explain your reasoning in natural language. Then, on the LAST line of your response, output a SINGLE JSON object (no markdown fences) with this structure:
...
First, briefly describe what you're about to change. Then, on the LAST line of your response, output a SINGLE JSON object (no markdown fences) with this structure:
